SUBROUTINE BUDGET(et_method)
  ...
  REAL sm, dep, req, rsup, rtot, shrt, cumet, dcumet, shorts_from_reduc, er_st
  REAL srsup, srtot, ssm, sdep, sreq, sshrt, sshorts_from_reduc, ser_st
  DATA NPRINT/0/
	...
	DO IY = 1, NYRS
	   ...
	   DO 110 I = 1, nperiods(IY)
		 ...
		 label = amn(I)
	      ...
	      IF (SPFLAG .EQ. 1) THEN
		 READ(12,*) rtot, rsup, er_st, req, sm, dep, shrt, shorts_from_reduc
	      ELSE
		 READ(12,*) rsup,req,sm,dep, shorts_from_reduc
	      ...
	      IF (TYPOUT(IB).GE.2 .AND. SPFLAG.EQ.1) &	
		   WRITE(7,933) QUOTE,label,QUOTE,QUOTE,na,QUOTE,QUOTE, &
                   ...
                   na,QUOTE,QUOTE,na,QUOTE,QUOTE,na,QUOTE,QUOTE, &
                   na,QUOTE,QUOTE,na,QUOTE, &
                   rtot,rsup,er_st,QUOTE,na,QUOTE,req,sm, &
	   ...
	   IF (TYPOUT(IB).GE.2) THEN
	      ...
	      IF(SPFLAG .EQ. 0) &
		   WRITE(7,904) QUOTE,QUOTE,QUOTE,na,QUOTE,QUOTE, &
                   ...
                   srtot,QUOTE,srsup,ser_st,QUOTE,na,QUOTE, &
                   sreq,ssm,QUOTE,na, &
	      ...
	      IF(SPFLAG .EQ. 1)  &
		   WRITE(7,934) QUOTE,QUOTE,QUOTE,na,QUOTE,QUOTE, &
                   ...
                   na,QUOTE,QUOTE,na,QUOTE,QUOTE,na,QUOTE,QUOTE, &
                   na,QUOTE,QUOTE,na,QUOTE, &
                   srtot,srsup,ser_st,QUOTE,na,QUOTE, &
...
903 FORMAT(1x,A1,A6,A1,1x,2(A1,A10,A1),2x,7(A1,A10,A1), &
       1x,2(F12.4),1x,2(A1,1x,A10,1x,A1),2(F12.4),A1,A10,A1,F12.4, &
       7(A1,1x,A10,1x,A1), F12.4,(A1,1x,A10,1x,A1))
904 FORMAT(A1,'Total',A1,2(A1,A10,A1),2x,8(A1,A10,A1), &
       1x,F12.4,1x,A1,2(1x,A10,1x,A1),2(F12.4),A1,A10,A1,F12.4, &
       7(A1,1x,A10,1x,A1), F12.4,(A1,1x,A10,1x,A1))
933 FORMAT(1x,A1,A6,A1,1x,2(A1,A10,A1),2x,7(A1,A10,A1), &
       1x,3(F12.4),1(A1,A10,A1),4(F12.4),7(A1,1x,A10,1x,A1), F12.4,(A1,1x,A10,1x,A1))
...
913 FORMAT(1x,A1,A6,A1,1x,2(A1,A10,A1),2x,7(A1,A10,A1), 2(F12.4), &
       2(A1,1x,A10,1x,A1),F12.4,2(A1,A10,A1),F12.4,7(A1,1x,A10,1x,A1), &
       F12.4)
914 FORMAT(A1,'Total',A1,2(A1,A10,A1),2x,7(A1,A10,A1), 2(F12.4), &
       2(A1,1x,A10,1x,A1),F12.4,2(A1,A10,A1),F12.4,7(A1,1x,A10,1x,A1), &
       F12.4)
